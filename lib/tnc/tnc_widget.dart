...
class TnccWidget extends StatefulWidget {
  ...
  @override
  _TnccWidgetState createState() => _TnccWidgetState();
}

class _TnccWidgetState extends State<TnccWidget> {
  late TnccModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TnccModel());
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              '   1.   This apk is valid for the people\n       of all the  age groups\n',
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '  2.  This apk works under the \n       integration of the goverment\n       of India as per their records\n',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
